...
| `fpm-8` `fpm-8.2` `fpm-8.2.1` `fpm-8.2.1-r1` | `sha256:451d8158221ca6e11112a86bd17df0d65d65c2e8064fd34a2345d078fd6f1274`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:451d8158221ca6e11112a86bd17df0d65d65c2e8064fd34a2345d078fd6f1274) | `amd64` `arm64` |
...
| `8` `8.2` `8.2.1` `8.2.1-r1` `latest` | `sha256:9d2e86ddbd8e750ad96ea2ae746bd561533addc5964db90897afb3b8db6d70f4`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:9d2e86ddbd8e750ad96ea2ae746bd561533addc5964db90897afb3b8db6d70f4) | `amd64` `arm64` |
...
| `dev-8` `dev-8.2` `dev-8.2.1` `dev-8.2.1-r1` | `sha256:f37a1cdd49e7db7facd344fd466996bb05b1f83faac4e6c3e5f102ffc31b9679`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:f37a1cdd49e7db7facd344fd466996bb05b1f83faac4e6c3e5f102ffc31b9679) | `amd64` `arm64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:9d2e86ddbd8e750ad96ea2ae746bd561533addc5964db90897afb3b8db6d70f4"
      },
    ...
    "optional": {
      ...
      "Bundle": {
        "SignedEntryTimestamp": "MEYCIQDOJCi7ymTlddehvbocwNMyll3uU5ZLwvLu46/x/Jcd3AIhAOwCVgIbVi1Ah8zqcHhw0z+QJ0yfl1EEICm7u5EoG2yG",
        "Payload": {
          "body": "",
          "integratedTime": 1675469381,
          "logIndex": 12576696,
