...
| `8` `8.2` `8.2.2` `8.2.2-r0` `latest` | `sha256:fb8bf9e999b3e9a9f636946e239f98f232f54fa0be0e5902dfe77c0e2c8df19c`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:fb8bf9e999b3e9a9f636946e239f98f232f54fa0be0e5902dfe77c0e2c8df19c) | `amd64` `arm64` |
...
| `fpm-8` `fpm-8.2` `fpm-8.2.2` `fpm-8.2.2-r0` | `sha256:941d9d5fce6203a43ab0814a68820fcf036aab3b613cb81c3737fd8b9cd9f55b`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:941d9d5fce6203a43ab0814a68820fcf036aab3b613cb81c3737fd8b9cd9f55b) | `amd64` `arm64` |
...
| `dev-8` `dev-8.2` `dev-8.2.2` `dev-8.2.2-r0` | `sha256:3bf08d832dfdadea9a3ca11f09c7983a4110d32bdcee2776a336db792101531b`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:3bf08d832dfdadea9a3ca11f09c7983a4110d32bdcee2776a336db792101531b) | `amd64` `arm64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:fb8bf9e999b3e9a9f636946e239f98f232f54fa0be0e5902dfe77c0e2c8df19c"
      },
    ...
    "optional": {
      ...
      "Bundle": {
        "SignedEntryTimestamp": "MEYCIQCFmVMceQQ9AtDqdWCEkrEsuXK5WHjiyT18sQ2I6wyabAIhALNoJZ8EMNKve6V37n8rWra50ecVXo8tcYgAxb23PBOc",
        "Payload": {
          "body": "",
          "integratedTime": 1676247024,
          "logIndex": 13204426,
